...
function PreContact() {
  return (
    <div className="w-4/5 mt-20 h-32 mb-40 flex flex-col justify-center items-center text-center pt-36 pb-[1100px] sm:pt-12 sm:pb-40 sm:mb-144 sm:mt-0 2xl:pt-36 2xl:pb-96">
