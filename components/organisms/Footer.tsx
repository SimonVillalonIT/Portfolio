        ...
        <div className="flex w-screen h-full justify-around">
          <div className="w-1/3 flex justify-end">
            <div className="bg-white/60 w-fit p-6 rounded-tl-5xl h-fit flex flex-col items-center rounded-br-5xl">
              <div className="text-gray-dark font-bold">
                <p>Simón Enoch Villalón</p>
                <p>simonvillalon10@gmail.com</p>
                <p>+54 3571 665914</p>
              </div>
              <div className="mt-8">
          ...
          <div className="flex flex-col w-1/3 items-center">
            ...
            <div className="flex flex-col justify-around h-full">
              <Link href="/"> <p className="text-xl">Main</p></Link>
              <Link href="/#About">
              <p className="text-xl">About</p></Link>
              <Link href="/#Contact">
              <p className="text-xl">Contact</p></Link>
            </div>
          </div>
